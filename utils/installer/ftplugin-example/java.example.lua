...
local bundles = {
  vim.fn.glob("/home/david/.config/lunarvim-debug-support/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"),
};
-- This is the new part
vim.list_extend(bundles, vim.split(vim.fn.glob("/home/david/.config/lunarvim-debug-support/vscode-java-test/server/*.jar"), "\n"))
